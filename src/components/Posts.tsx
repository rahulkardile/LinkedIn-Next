  ...
  return (
    <div className='bg-white rounded-lg p-5 mb-4'>
        <div className="">
          ...
          <div className="">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rerum accusantium aliquid, maxime praesentium perferendis autem sunt fuga perspiciatis doloribus suscipit. Quis, hic nam deleniti qui illo doloribus minima modi eum.
          </div>
